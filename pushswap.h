...
/*   Updated: 2022/07/27 16:00:28 by pmeising         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_find_steps_while_pushing(struct s_stacks **a, struct s_stacks **b,
			int k);
...
void	ft_trlt_op(struct s_stacks **a, struct s_stacks **b, char *instruction);
