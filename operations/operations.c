...
/*   Updated: 2022/07/28 11:19:17 by pmeising         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_ops_1(struct s_stacks **a, struct s_stacks **b, int operation)
{
	if (operation == 1)
	{
		ft_swap(a);
...
static void	ft_ops_2(struct s_stacks **a, struct s_stacks **b, int operation)
{
	if (operation == 5)
	{
		ft_rotate(a);
